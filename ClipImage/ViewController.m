...
//- (IBAction)koutu:(UIButton *)sender
//{
...
//{
//    self.imageView.frame = CGRectMake(self.imageView.frame.origin.x, self.imageView.frame.origin.y, self.imageView.frame.size.width+5, self.imageView.frame.size.height+5);
//
//}
...
- (IBAction)cilpImage:(UIButton *)sender
{
    ...
    if (self.imageView)
    {
        ...
        CGRect rect = CGRectMake(point.x*2, point.y*2, width*2, height*2);
...
//        self.imageView.hidden = YES;
        UIImageView *imageViewEnd = [[UIImageView alloc] initWithFrame:CGRectMake(0, 200, width, height)];
        imageViewEnd.image = imageEnd;
        imageViewEnd.backgroundColor = [UIColor redColor];
        imageViewEnd.contentMode = UIViewContentModeScaleToFill;
        [self.view addSubview:imageViewEnd];
